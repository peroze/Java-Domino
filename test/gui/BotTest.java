...
public class BotTest {
    ...
    public void testSearchtile() {
        ...
        table.add(new Tile(4,4));
        test=instance.searchtile(table);
        expResult=new Tile(6,4);//We know that the first tile that fits is the 4th(because we haven't shuffled the list) and it should be reversed
        if (test.get(1)==1){
